...
<div class="inner-box page-content" style="background-color:#fff">
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="">
                        ...
                        <div class="relative location-content" style="text-align: center;">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div>
                                        @if ($loc['show'] && $map['show'])
                                            <h2 class="title-3" style="text-align: center;">
                            ...
                            @if ($loc['showButton'])
                                ...
                                @if (!auth()->check() and config('settings.single.guests_can_post_ads') != '1')
                                    <a class="btn-awesome-2" href="#quickLogin" data-toggle="modal">
                                        {{ t('Add Listing') }}
                                    </a>
                                @else
                                    <a class="btn-awesome-2" href="{{ lurl('posts/create') }}" >
                                        {{ t('Add Listing') }}
                                    </a>
                                @endif
                            @endif
